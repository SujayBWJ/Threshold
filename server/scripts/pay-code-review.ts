/**
 * End-to-end x402 TestNet payment client for POST /api/code-review.
 */
...
const testUrl = `${baseUrl.replace(/\/$/, "")}/api/code-review`;
...
async function main(): Promise<void> {
  ...
  console.log("=== Threshold x402 payment test for Code Review ===");
  ...
  console.log("\n[1] POST /api/code-review without payment");
